package br.com.sgpi.cliente.infra.exception;

import br.com.sgpi.cliente.infra.util.MessageService;
...
public class ClienteExceptionHandler {
    ...
    public ResponseEntity tratarErro404(EntityNotFoundException ex) {
        return ResponseEntity.badRequest().body((new DadosErro(
                ex, messageService.getMessage(MessageService.RECURSO_NAO_ENCONTRADO))));
    }
